...
int do_sys_kernel_mm_ksm(int update_every, unsigned long long dt) {
    ...
    if(!st) {
        ...
        rrddim_add(st, "shared", NULL, 1, 1024 * 1024, RRDDIM_ABSOLUTE, NULL);
        rrddim_add(st, "unshared", NULL, -1, 1024 * 1024, RRDDIM_ABSOLUTE, NULL);
        rrddim_add(st, "sharing", NULL, 1, 1024 * 1024, RRDDIM_ABSOLUTE, NULL);
        rrddim_add(st, "volatile", NULL, -1, 1024 * 1024, RRDDIM_ABSOLUTE, NULL);
        rrddim_add(st, "to_scan", "to scan", -1, 1024 * 1024, RRDDIM_ABSOLUTE, NULL);
    }
    else rrdset_next(st);
    ...
    if(!st) {
        ...
        rrddim_add(st, "savings", NULL, -1, 1024 * 1024, RRDDIM_ABSOLUTE, NULL);
        rrddim_add(st, "offered", NULL, 1, 1024 * 1024, RRDDIM_ABSOLUTE, NULL);
    }
    else rrdset_next(st);
    ...
    if(!st) {
        ...
        rrddim_add(st, "savings", NULL, 1, 10000, RRDDIM_ABSOLUTE, NULL);
    }
    else rrdset_next(st);
