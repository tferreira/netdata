...
int do_proc_stat(int update_every, unsigned long long dt) {
        ...
        if(likely(row_key[0] == 'c' && row_key[1] == 'p' && row_key[2] == 'u')) {
            ...
            if(likely((isthistotal && do_cpu) || (!isthistotal && do_cpu_cores))) {
                ...
                if(unlikely(!st)) {
                    ...
                    rrddim_add(st, "guest_nice", NULL, multiplier, divisor, RRDDIM_PCENT_OVER_DIFF_TOTAL, NULL);
                    rrddim_add(st, "guest", NULL, multiplier, divisor, RRDDIM_PCENT_OVER_DIFF_TOTAL, NULL);
                    rrddim_add(st, "steal", NULL, multiplier, divisor, RRDDIM_PCENT_OVER_DIFF_TOTAL, NULL);
                    rrddim_add(st, "softirq", NULL, multiplier, divisor, RRDDIM_PCENT_OVER_DIFF_TOTAL, NULL);
                    rrddim_add(st, "irq", NULL, multiplier, divisor, RRDDIM_PCENT_OVER_DIFF_TOTAL, NULL);
                    rrddim_add(st, "user", NULL, multiplier, divisor, RRDDIM_PCENT_OVER_DIFF_TOTAL, NULL);
                    rrddim_add(st, "system", NULL, multiplier, divisor, RRDDIM_PCENT_OVER_DIFF_TOTAL, NULL);
                    rrddim_add(st, "nice", NULL, multiplier, divisor, RRDDIM_PCENT_OVER_DIFF_TOTAL, NULL);
                    rrddim_add(st, "iowait", NULL, multiplier, divisor, RRDDIM_PCENT_OVER_DIFF_TOTAL, NULL);

                    rrddim_add(st, "idle", NULL, multiplier, divisor, RRDDIM_PCENT_OVER_DIFF_TOTAL, NULL);
                    rrddim_hide(st, "idle");
                }
                else rrdset_next(st);
            ...
            if(likely(do_interrupts)) {
                ...
                if(unlikely(!st)) {
                    ...
                    rrddim_add(st, "interrupts", NULL, 1, 1, RRDDIM_INCREMENTAL, NULL);
                }
                else rrdset_next(st);
            ...
            if(likely(do_context)) {
                ...
                if(unlikely(!st)) {
                    ...
                    rrddim_add(st, "switches", NULL, 1, 1, RRDDIM_INCREMENTAL, NULL);
                }
                else rrdset_next(st);
    ...
    if(likely(do_forks)) {
        ...
        if(unlikely(!st)) {
            ...
            rrddim_add(st, "started", NULL, 1, 1, RRDDIM_INCREMENTAL, NULL);
        }
        else rrdset_next(st);
    ...
    if(likely(do_processes)) {
        ...
        if(unlikely(!st)) {
            ...
            rrddim_add(st, "running", NULL, 1, 1, RRDDIM_ABSOLUTE, NULL);
            rrddim_add(st, "blocked", NULL, -1, 1, RRDDIM_ABSOLUTE, NULL);
        }
        else rrdset_next(st);
