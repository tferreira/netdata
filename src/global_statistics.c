...
void global_statistics_charts(void) {
    ...
    if (!stclients) {
        ...
        rrddim_add(stclients, "clients", NULL, 1, 1, RRDDIM_ABSOLUTE, NULL);
    ...
    if (!streqs) {
        ...
        rrddim_add(streqs, "requests", NULL, 1, 1, RRDDIM_INCREMENTAL, NULL);
    ...
    if (!stbytes) {
        ...
        rrddim_add(stbytes, "in", NULL, 8, 1024, RRDDIM_INCREMENTAL, NULL);
        rrddim_add(stbytes, "out", NULL, -8, 1024, RRDDIM_INCREMENTAL, NULL);
    ...
    if (!stduration) {
        ...
        rrddim_add(stduration, "average", NULL, 1, 1000, RRDDIM_ABSOLUTE, NULL);
        rrddim_add(stduration, "max", NULL, 1, 1000, RRDDIM_ABSOLUTE, NULL);
    ...
    if (!stcompression) {
        ...
        rrddim_add(stcompression, "savings", NULL, 1, 1000, RRDDIM_ABSOLUTE, NULL);
