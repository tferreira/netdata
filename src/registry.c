...
void registry_statistics(void) {
    ...
    if(!sts) {
        ...
        rrddim_add(sts, "sessions",  NULL,  1, 1, RRDDIM_ABSOLUTE, NULL);
    }
    ...
    if(!stc) {
        ...
        rrddim_add(stc, "persons",        NULL,  1, 1, RRDDIM_ABSOLUTE, NULL);
        rrddim_add(stc, "machines",       NULL,  1, 1, RRDDIM_ABSOLUTE, NULL);
        rrddim_add(stc, "urls",           NULL,  1, 1, RRDDIM_ABSOLUTE, NULL);
        rrddim_add(stc, "persons_urls",   NULL,  1, 1, RRDDIM_ABSOLUTE, NULL);
        rrddim_add(stc, "machines_urls",  NULL,  1, 1, RRDDIM_ABSOLUTE, NULL);
    }
    ...
    if(!stm) {
        ...
        rrddim_add(stm, "persons",        NULL,  1, 1024, RRDDIM_ABSOLUTE, NULL);
        rrddim_add(stm, "machines",       NULL,  1, 1024, RRDDIM_ABSOLUTE, NULL);
        rrddim_add(stm, "urls",           NULL,  1, 1024, RRDDIM_ABSOLUTE, NULL);
        rrddim_add(stm, "persons_urls",   NULL,  1, 1024, RRDDIM_ABSOLUTE, NULL);
        rrddim_add(stm, "machines_urls",  NULL,  1, 1024, RRDDIM_ABSOLUTE, NULL);
    }
