...
void *checks_main(void *ptr)
{
    ...
    rrddim_add(check1, "absolute", NULL, -1, 1, RRDDIM_ABSOLUTE, NULL);
    rrddim_add(check1, "incremental", NULL, 1, 1, RRDDIM_INCREMENTAL, NULL);
    ...
    rrddim_add(check2, "absolute", NULL, -1, 1, RRDDIM_ABSOLUTE, NULL);
    rrddim_add(check2, "incremental", NULL, 1, 1, RRDDIM_INCREMENTAL, NULL);
    ...
    rrddim_add(check3, "caller", NULL, 1, 1, RRDDIM_ABSOLUTE, NULL);
    rrddim_add(check3, "netdata", NULL, 1, 1, RRDDIM_ABSOLUTE, NULL);
    rrddim_add(check3, "apps.plugin", NULL, 1, 1, RRDDIM_ABSOLUTE, NULL);
